...
namespace XRMultiplayer
{
    ...
    public class XRINetworkGameManager : NetworkBehaviour
    {
        ...
        /// </summary>
        public static BindableVariable<string> LocalPlayerName = new(k_DefaultPlayerName);
        ...
        public string defaultPlayerName => m_DefaultPlayerName;
        [SerializeField]
        string m_DefaultPlayerName = k_DefaultPlayerName;
        ...
        protected virtual async void Awake()
        {
            ...
            // Update default name if changed.
            if (!m_DefaultPlayerName.Equals(k_DefaultPlayerName))
                LocalPlayerName.Value = m_DefaultPlayerName;
        ...
        /// <summary>
        /// Sometimes we will check for a player by ID and they may not have assigned their client PlayerObject yet.
        /// This method is a slower lookup, but can be used in those cases.
        /// </summary>
        /// <param name="id"></param>
        /// <returns></returns>
